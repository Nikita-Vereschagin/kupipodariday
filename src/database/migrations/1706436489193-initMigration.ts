...
export class InitMigration1706436489193 implements MigrationInterface {
    name = 'InitMigration1706436489193'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "offer" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL, "updatedAt" TIMESTAMP NOT NULL, "hidden" boolean NOT NULL DEFAULT false, "amount" real NOT NULL DEFAULT '0.01', "userId" integer, "itemId" integer, CONSTRAINT "PK_57c6ae1abe49201919ef68de900" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "wish" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL, "updatedAt" TIMESTAMP NOT NULL, "name" character varying NOT NULL DEFAULT 'Супер пупер крутая вещь, купишь - не пожалеешь, отвечаю :O ', "link" character varying NOT NULL DEFAULT 'https://superpuper/228', "image" character varying NOT NULL DEFAULT 'https://superpuper/228', "price" real NOT NULL DEFAULT '0.99', "raised" real NOT NULL DEFAULT '0.01', "description" text NOT NULL DEFAULT 'Очень крутой подарок.', "copied" integer NOT NULL DEFAULT '0', "ownerId" integer, CONSTRAINT "PK_e338d8f62014703650439326d3a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "wishlist" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL, "updatedAt" TIMESTAMP NOT NULL, "name" character varying NOT NULL DEFAULT 'Супер пупер список', "image" character varying NOT NULL DEFAULT 'https://superpuper/228', "description" text NOT NULL DEFAULT 'Отвечаю, Джони Депп позавидует такой одежде', "ownerId" integer, CONSTRAINT "PK_620bff4a240d66c357b5d820eaa" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "username" character varying NOT NULL DEFAULT 'Vasya228', "about" text NOT NULL DEFAULT 'Пока ничего не рассказал о себе.', "avatar" character varying NOT NULL DEFAULT 'https://i.pravatar.cc/300', "email" character varying NOT NULL DEFAULT 'vasya228@ya.ru', "password" character varying NOT NULL, CONSTRAINT "UQ_78a916df40e02a9deb1c4b75edb" UNIQUE ("username"), CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
